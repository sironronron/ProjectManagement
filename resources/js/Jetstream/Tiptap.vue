<template>
    <div>
        <div class="flex flex-col items-start md:flex-row w-full md:items-center flex-wrap mt-5 mb-8 bg-gray-100" v-if="editor">
        ...
        <editor-content :editor="editor" class="mb-12" />
    </div>
</template>
