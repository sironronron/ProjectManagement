            ...
            <div class="mt-5">
                <jet-form-section @submitted="updateTask">
                    ...
                    <template #description>
                        Update your task! Tasks will help you monitor you project's progress.
                    </template>
...
<script>
    ...
    export default {
        props: ['project', 'task', 'project_task_statuses', 'project_milestones', 'members'],
        ...
        data () {
            return {
                form: this.$inertia.form({
                    ...
                    status_id: this.task.statud_id,
                    priority: this.task.priority,
                    visible_to_client: this.task.visible_to_client == 1 ? true : false,
        ...
        methods: {
            updateTask () {
                this.form.put(route('', { project: this.project.unique_id, project_task: this.task.unique_id }), {
                    _method: 'PUT',
                    errorBag: 'updateTask',
                    preserveScroll: true
                })
