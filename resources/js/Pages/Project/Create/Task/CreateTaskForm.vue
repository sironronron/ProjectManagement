<template>
    <jet-form-section @submitted="createNewTask">
        <template #title> Task Information </template>

        <template #description>
            Add new task to project! Tasks will help you monitor your project's
            progress
        </template>
        ...
        <template #form>
            ...
            <div class="col-span-6 sm:col-span-4">
                ...
                >
                    ...
                    <option
                        v-for="(milestone, key) in project_milestones"
                        :key="key"
                        :value="milestone.unique_id"
                    >
                        {{ milestone.name }}
                    </option>
                </select>
                <jet-input-error
                    :message="form.errors.milestone_id"
                    class="mt-2"
                />
            </div>

            <div class="col-span-6 sm:col-span-4">
                <jet-label for="assigned_to" value="Assign To" class="mb-2" />
                <multiselect
                ...
                >
                    ...
                    >
                        ...
                        >
                            ...
                            <div class="text-sm text-white font-semibold ml-2">
                                {{ option.label }}
                            </div>
                            <div
                                v-if="!disabled"
            ...
            <!-- Description -->
            <div class="col-span-6 sm:col-span-4">
                <jet-label for="description" value="Description" class="mb-2" />
                <tiptap
            ...
            <div class="col-span-6 sm:col-span-4">
                ...
                >
                    ...
                    <option
                        v-for="(status, key) in project_task_statuses"
                        :key="key"
                        :value="status.id"
                    >
                        {{ status.name }}
                ...
                <div class="block mt-4">
                    <label class="flex items-center">
                        <jet-checkbox
                            ...
                            v-model:checked="form.visible_to_client"
                        />
                    ...
                    <jet-input-error
                        :message="form.errors.visible_to_client"
                        class="mt-2"
                    />
                </div>
            </div>
            ...
            <div class="col-span-6 sm:col-span-4">
                <div class="block">
                    <label class="flex items-center">
                        <jet-checkbox
                            name="billable"
                            v-model:checked="form.billable"
                        />
                        <span class="ml-4 text-sm text-gray-600">Billable</span>
                    </label>
                    <jet-input-error
                        :message="form.errors.billable"
                        class="mt-2"
                    />
                </div>
            </div>
