    ...
    export default {
        ...
        data () {
            return {
                form: this.$inertia.form({
                    _method: 'PUT',
                    name: this.client_category.name,
                    description: this.client_category.description,
                })
            }
        },
        ...
        methods: {
            updateProjectCategory () {
                this.form.put(route('clients.categories.update', this.client_category.unique_id), {
