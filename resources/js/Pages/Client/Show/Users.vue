    ...
    <app-layout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                {{ client.company_name }}
                <span class="text-gray-200 mx-5">|</span> Users
            </h2>
        </template>
        ...
        <jet-confirmation-modal
            :show="clientUserBeingRemoved"
            @close="clientUserBeingRemoved = null"
        >
            <template #title> Remove client user </template>
            ...
            <template #footer>
                ...
                <jet-danger-button
                    class="ml-2"
                    @click="removeClientUser"
                    :class="{ 'opacity-25': removeClientUserForm.processing }"
                    :disabled="removeClientUserForm.processing"
                >
                    Remove
                </jet-danger-button>
            </template>
...
export default {
    ...
    methods: {
        ...
        removeClientUser() {
            this.removeClientUserForm.delete(
                route("client_users.destroy", [this.clientUserBeingRemoved.id]),
                {
